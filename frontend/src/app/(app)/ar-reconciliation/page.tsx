  ...
  return (
    <>
      <div className={styles.pageHead}>
        ...
        {canCreate && <NewRunModal companies={companyList} isSuperAdmin={user.isSuperAdmin} />}
      </div>
              ...
              <tbody>
                {rows.map((r) => (
                  <tr key={r.id}>
                    ...
                    <td style={{ color: "var(--ink-2)" }}>{r.createdByName ?? "—"}</td>
                    <td>
